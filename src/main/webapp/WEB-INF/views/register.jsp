    ...
    <body class="corporate">
                ...
                <div class="row">
                    ...
                    <div class="col-md-12 col-sm-12 additional-nav" style=" font-size:11px; font-color:000000">
                        <ul class="list-unstyled list-inline pull-right ">
                            <li style="font-size:12px"><i class=" fa fa-phone"></i><span>Lets Talk: +91 9019602602</span></li>
                        </ul>
                    </div>
                    <!-- END TOP BAR MENU -->
                </div>
        ...
        <div class="header">
            <div class="container">
                <a class="site-logo" href="#">
                    <img src="corporate/img/logos/logo.png" alt="Metronic FrontEnd"> </a>
            ...
            <div class="container">
                ...
                <div class="row margin-bottom-30 front-steps-wrapper">
                    <div class="front-step front-stepv margin-top-20">
                        <div class="row">
                            <div class="col-lg-6 col-md-6 col-sm-6 margin-top-10 ">
                                <div class="col-lg-12 col-md-12 col-sm-12 margin-top-10 ">
                                    <h2 style="font-family:Roboto; font-size:70px">Register into the thinking network</h2>
                                </div>
                            </div>
                            <div class="col-lg-4 col-md-4 col-sm-5 pull-right  " style="font-family:Lato; font-wait:100">
                                <div class="form-info">
                                    <p style="font-family:Roboto; font-color:#gray; font-size:16px; padding-bottom:10px"> Register </P>
                                        ...
                                        <form class="form-horizontal form-without-legend" role="form">
                                            ...
                                            <div class="row">
                                                <div class="col-lg-10 col-md-offset-1 padding-left-0 padding-right-0 padding-top-10" >
                                                    <!-- <p style="color:gray; font-size:11px; line-height:1">If you are already a stoic customer and don’t have my stoic account, you can<a style="color:#7E548A; font-size:12px; line-height: 1;" href="#"> register now</a>. It is prety quick.</p>-->
                                                </div>
                                            </div>
                                            <div class="row">
                        ...
                        <div class="col-lg-12 col-md-12 col-sm-12 margin-top-20 padding-top-10">
        ...
        <div class="footer" style="font-family:Roboto; position: fixed; right: 0; bottom: 0; left: 0;font-size:10px">
            <div class="container">
                <div class="row">
                    <!-- BEGIN COPYRIGHT -->
                    <div class="col-md-10 col-sm-10 padding-top-0 padding-bottom-10 "> 2017 &copy oneEight. ALL Rights Reserved.&nbsp 
