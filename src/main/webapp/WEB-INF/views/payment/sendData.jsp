        ...
        <form method="post" name="customerData" action="ccavRequestHandler" >
            ...
            <div class="col-md-7 col-xs-12">
                ...
                <div class="mainBlock31" style="color:black;">
                    ...
                    <div class="col-md-5 col-xs-12">
                        <h3><span class="highlight1">Details</span></h3><hr>
                    ...
                    <div class="col-md-6 col-sm-7">
                        ...
                        <div class="col-md-12 col-sm-12">
                            <div class="row">
                               <h3 style="padding-left:5px;"><span class="highlight1">Payment Option</span></h3><hr>
                            </div>
                            <div class="row">
                                <div class="col-md-6 col-sm-6">
                                    <input type="radio" name="payment_option" value="OPTCRDC" id="radio1" class="css-checkbox" />
            ...
            <input type="hidden" name="redirect_url" value="https://www.mynuron.co.in/ccavResponseHandler"/><!-- Redirect URL	: -->
